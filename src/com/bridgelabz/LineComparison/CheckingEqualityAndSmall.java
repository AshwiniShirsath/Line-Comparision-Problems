...
public class CheckingEqualityAndSmall {
    ...
    public static void main(String[] args) {
    	...
    	CheckingEqualityAndSmall CE1 = new CheckingEqualityAndSmall();
    	CheckingEqualityAndSmall CE2 = new CheckingEqualityAndSmall();
        ...
        double line1Length = CE1.getLengthOfLine();
        double line2Length = CE2.getLengthOfLine();
